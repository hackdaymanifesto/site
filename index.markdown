...
such a code encourages diversity of participation and creates and maintains a 
welcoming envrionment. It is highly recommended to adopt a code of conduct for 
your event such as the [Hack Code of Conduct](http://hackcodeofconduct.org), 
which may be either referenced directly or by creating a custom version of this
code of conduct for your event, and to communicate clearly to attendees ahead of
time the existence of this code ane the enforcement policy behind it.  
